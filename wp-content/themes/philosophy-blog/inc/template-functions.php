 ...
 * @return array
 */
function philosophy_blog_body_classes( $classes ) {
...
add_filter( 'body_class', 'philosophy_blog_body_classes' );

/**
 * Add a pingback url auto-discovery header for single posts, pages, or attachments.
 */
function philosophy_blog_pingback_header() {
	if ( is_singular() && pings_open() ) {
		printf( '<link rel="pingback" href="%s">', esc_url( get_bloginfo( 'pingback_url' ) ) );
	}
}
add_action( 'wp_head', 'philosophy_blog_pingback_header' );

/**
 * philosophy_blog Excerpt Length
 *
 * @since philosophy_blog 1.0.0
 *
 * @param null
 * @return void
 */

if ( ! function_exists( 'philosophy_blog_excerpt_length' ) ) :
   ...
   */
  function philosophy_blog_excerpt_length( $length ) {
...
add_filter( 'excerpt_length', 'philosophy_blog_excerpt_length', 999 );
